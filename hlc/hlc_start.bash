...
/opt/MATLAB/R2018b/bin/matlab -nodisplay -nosplash -logfile matlab.log -nodesktop -r "cd '/tmp/software/hlc/${script_path}'; ${script_name}(1, '${vehicle_id}')" #1 is the local comm. domain ID, cannot be changed currently