...
int main(int argc, char *argv[])
{
    ...
    /*string files_str = exec("find /home/janis/sciebo/CPM-Lab/04_Measurement/AprilTag_MotionBlurTest/Light_Floodlight__Exposure_500us__MotorCurrent_2A__Gain_15__Distanz_230cm -type f | sort");
    ...
    vector<string> files {"2017-10-06_19-29-02.809235.tif", "2017-10-06_19-29-02.825759.tif", "2017-10-06_19-29-02.841888.tif", "2017-10-06_19-29-02.858598.tif", "2017-10-06_19-29-02.874674.tif", "2017-10-06_19-29-02.891259.tif", "2017-10-06_19-29-02.907501.tif", "2017-10-06_19-29-02.924096.tif", "2017-10-06_19-29-02.940477.tif", "2017-10-06_19-29-02.957442.tif", "2017-10-06_19-29-02.973361.tif", "2017-10-06_19-29-02.989812.tif", "2017-10-06_19-29-03.005865.tif", "2017-10-06_19-29-03.022512.tif", "2017-10-06_19-29-03.038595.tif", "2017-10-06_19-29-03.055302.tif", "2017-10-06_19-29-03.071749.tif", "2017-10-06_19-29-03.087944.tif", "2017-10-06_19-29-03.104238.tif"};

    assert(files.size()>10);

    int frame_index = 0;
    vector<Mat> frames;
    for(auto filename:files) frames.push_back(imread("../img/"+filename));
    ...
    while (true) {
        ...
        for(int idx_roi = 0; idx_roi < ROIs.size(); idx_roi++) {
            ...
            Mat gray_cropped_org = gray(ROI);
            Mat gray_cropped;

            gray_cropped_org.copyTo(gray_cropped);

            cout << "step " << gray_cropped.step.buf[0] << endl;
