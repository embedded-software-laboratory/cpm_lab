...
static inline void test_sequence(spi_mosi_data_t* spi_mosi_data, spi_miso_data_t* spi_miso_data)
{
	...
	//
	//// LED1
	//if(tick%(50*period)<50*2) {
		//spi_mosi_data->LED1_period_ticks = 25;
		//spi_mosi_data->LED1_enabled_ticks = 12;
	//}
	//// LED2
	//else if(tick%(50*period)<50*4) {
		//spi_mosi_data->LED2_period_ticks = 25;
		//spi_mosi_data->LED2_enabled_ticks = 12;
	//}
	//
	//// LED3
	//else if(tick%(50*period)<50*6) { 
		//spi_mosi_data->LED3_period_ticks = 25;
		//spi_mosi_data->LED3_enabled_ticks = 12;
	//}
	//
	//// LED4
	//else { 
		//spi_mosi_data->LED4_period_ticks = 25;
		//spi_mosi_data->LED4_enabled_ticks = 12;
	//}
