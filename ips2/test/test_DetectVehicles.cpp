...
TEST_CASE("TEST_apply_WITH_4_points_of_1_vehicle_SHOULD_detect_1_vehicle")
{
    ...
    // Test
    double d_front_back = vehicle_point_set.back_left.dot(vehicle_point_set.front);
    double d_back_back = vehicle_point_set.back_left.dot(vehicle_point_set.back_right);
