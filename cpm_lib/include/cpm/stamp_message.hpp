 ...
 * \brief This interface provides a method that can be used to set a time stamp for a sample (for creation and validity)
 */
...
{
    /**
     * \brief This function takes a sample reference and sets its timestamp for the time of creation (t_now) and the timestamp for the time of validity (t_now + expected_delay) from which on the sample can be used by the receiver
