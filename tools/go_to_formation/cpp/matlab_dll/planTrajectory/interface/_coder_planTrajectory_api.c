...
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, struct0_T y[20]);
...
static real_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *vehicleIdList, const char_T *identifier))[20];
  ...
  const char_T *identifier, struct0_T y[20])
{
  ...
  d_emlrt_marshallIn(sp, emlrtAlias(vehiclePoses), &thisId, y);
  ...
  emlrtMsgIdentifier *parentId, struct0_T y[20])
{
  ...
  for (i = 0; i < 20; i++) {
    ...
    y[i].vehicle_id = e_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp,
      u, i, 0, "vehicle_id")), &thisId);
    thisId.fIdentifier = "pose";
    y[i].pose = f_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, i,
      1, "pose")), &thisId);
  }
  ...
  *vehicleIdList, const char_T *identifier))[20]
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = b_emlrt_marshallIn(sp, emlrtAlias(vehicleIdList), &thisId);
  ...
  *egoVehicleId, const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = g_emlrt_marshallIn(sp, emlrtAlias(egoVehicleId), &thisId);
  ...
  mxArray *plhs[2])
{
  ...
  real_T (*vehicleIdList)[20];
  struct0_T vehiclePoses[20];
  Pose2D goalPose;
  real_T egoVehicleId;
  real_T speed;
  ...
  vehicleIdList = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "vehicleIdList");
  c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "vehiclePoses", vehiclePoses);
  ...
  speed = i_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "speed");

  /* Invoke the target function */
  planTrajectory(*vehicleIdList, vehiclePoses, &goalPose, egoVehicleId, speed,
