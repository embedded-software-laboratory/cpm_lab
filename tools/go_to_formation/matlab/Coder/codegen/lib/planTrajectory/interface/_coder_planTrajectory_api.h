...
extern void planTrajectory(real_T vehicleIdList_data[], int32_T
  vehicleIdList_size[2], struct0_T vehiclePoses_data[], int32_T
  vehiclePoses_size[2], Pose2D *goalPose, uint8_T egoVehicleId, real_T speed,
  emxArray_struct1_T *trajectory_points, boolean_T *isPathValid);
