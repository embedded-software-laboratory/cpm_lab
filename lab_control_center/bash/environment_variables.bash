...
# Get cpm directory relative to this script's directory
DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )/"
RELATIVE_CPM_DIR="${DIR}../../cpm_lib/build"
ABSOLUTE_CPM_DIR="$(realpath "${RELATIVE_CPM_DIR}")"

export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib64/:${ABSOLUTE_CPM_DIR}:/opt/rti_connext_dds-6.0.0/lib/x64Linux4gcc7.3.0
