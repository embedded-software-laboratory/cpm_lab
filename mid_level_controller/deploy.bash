...
echo "This script is deprecated. The vehicles now "
echo "actively download the software from the master PC via http."
echo "See 'bootloader_raspberry.bash'."
...
#sshpass -p t4nxAdDwrgqn scp -o StrictHostKeyChecking=no ../cpm_lib/build_arm/libcpm.so pi@$1:/tmp
#sleep 0.1
#
#echo "Running"
